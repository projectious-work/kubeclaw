...
title: Quick Start
weight: 5
description: "Provision the cluster end to end: prerequisites, Dev Container, OpenTofu, SSH, and the Cloudflare Tunnel."
---
...
See [Variables Reference]({{< relref "/docs/reference/variables" >}}) for all available configuration options.
...
{{< alert title="Rerun after every infrastructure change" >}}
...
covered step by step in the [Cloudflare Tunnel Setup]({{< relref "/docs/guide/cloudflare-tunnel" >}})
...
- [Server management with Ansible]({{< relref "/docs/guide/ansible" >}}) -- updates, hardening, and Kubernetes prerequisites
- [Deploy Kubernetes with kubeadm]({{< relref "/docs/guide/kubernetes" >}})
- [Deploy OpenClaw]({{< relref "/docs/guide/openclaw" >}}) into an egress-restricted namespace
- [DNS and NAT64]({{< relref "/docs/introduction/dns-and-nat64" >}}) for IPv4 reachability
