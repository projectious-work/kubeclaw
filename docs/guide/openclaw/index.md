...
- A running KubeClaw cluster (see [Kubernetes guide](/kubeclaw/docs/guide/kubernetes/))
...
If you haven't already set up the Hetzner Cloud infrastructure, follow the [Quick Start](/kubeclaw/docs/quick-start/) and [Kubernetes guide](/kubeclaw/docs/guide/kubernetes/).
...
- CoreDNS forwarding to DNS64 resolvers (see [Kubernetes guide, Step 4](/kubeclaw/docs/guide/kubernetes/))
...
<div class="alert alert-primary" role="alert"><div class="h4 alert-heading" role="heading">Model configuration</div>
...
<ul class="nav nav-tabs" id="tabs-7" role="tablist">
  <li class="nav-item">
      <button class="nav-link active"
          ...
          aria-controls="tabs-07-00" aria-selected="true">
        Telegram
      </button>
    </li><li class="nav-item">
      <button class="nav-link"
...
<div class="alert alert-primary" role="alert"><div class="h4 alert-heading" role="heading">Save the gateway token</div>
...
<ul class="nav nav-tabs" id="tabs-9" role="tablist">
  <li class="nav-item">
      ...
      <button class="nav-link"
          id="tabs-09-02-tab" data-bs-toggle="tab" data-bs-target="#tabs-09-02" role="tab"
          aria-controls="tabs-09-02" aria-selected="false">
        Signal
      </button>
    </li>
</ul>
...
```</code></pre>
    ...
    <div class="tab-pane fade"
        id="tabs-09-02" role="tabpanel" aria-labelled-by="tabs-09-02-tab" tabindex="9">
        <pre tabindex="0"><code>```yaml
apiVersion: apps/v1
kind: StatefulSet
metadata:
...
<div class="alert alert-primary" role="alert"><div class="h4 alert-heading" role="heading">Cilium FQDN egress whitelist</div>
...
<div class="alert alert-primary" role="alert"><div class="h4 alert-heading" role="heading">Startup time</div>
...
<div class="alert alert-primary" role="alert"><div class="h4 alert-heading" role="heading">Dedicated number recommended</div>
...
<div class="alert alert-primary" role="alert"><div class="h4 alert-heading" role="heading">WhatsApp credentials persist</div>
...
<div class="alert alert-primary" role="alert"><div class="h4 alert-heading" role="heading">Advanced setup</div>
...
<div class="alert alert-primary" role="alert"><div class="h4 alert-heading" role="heading">Registering deauthenticates</div>
...
<div class="alert alert-primary" role="alert"><div class="h4 alert-heading" role="heading">SSL/TLS settings</div>
...
<div class="alert alert-primary" role="alert"><div class="h4 alert-heading" role="heading">Two-layer authentication</div>
...
<ul class="nav nav-tabs" id="tabs-18" role="tablist">
  <li class="nav-item">
      ...
      <button class="nav-link"
          id="tabs-18-02-tab" data-bs-toggle="tab" data-bs-target="#tabs-18-02" role="tab"
          aria-controls="tabs-18-02" aria-selected="false">
        Signal
      </button>
    </li>
</ul>
...
<div class="tab-content" id="tabs-18-content">
    <div class="tab-pane fade show active"
        ...
        <pre tabindex="0"><code>1. Find your bot on Telegram
2. Send any message
3. OpenClaw should respond (only to your user ID)</code></pre>
    </div>
    <div class="tab-pane fade"
        id="tabs-18-01" role="tabpanel" aria-labelled-by="tabs-18-01-tab" tabindex="18">
        <pre tabindex="0"><code>1. Send a message to the linked WhatsApp number
2. OpenClaw should respond (only to numbers in `allowFrom`)</code></pre>
    </div>
    <div class="tab-pane fade"
        id="tabs-18-02" role="tabpanel" aria-labelled-by="tabs-18-02-tab" tabindex="18">
        <pre tabindex="0"><code>1. Send a message to the bot&#39;s Signal number
2. OpenClaw should respond (only to numbers in `allowFrom`)</code></pre>
    </div>
</div>
...
<div class="alert alert-primary" role="alert"><div class="h4 alert-heading" role="heading">Update your browser</div>
...
<div class="alert alert-primary" role="alert"><div class="h4 alert-heading" role="heading">Pin the version</div>
