...
KubeClaw's security is layered across three levels: Hetzner Cloud firewalls, host-level hardening, and Kubernetes network policies. See [Architecture](architecture.md) for the overall network design.
...
For operational security details (SSH configuration directives, monitoring, security auditing), see [Operations: Security](../operations/security.md).
