...
[control_nodes]
control-01 ansible_host=${CONTROL_IP}
...
ansible_ssh_private_key_file=~/.ssh/${CLUSTER_NAME}_control-node_key

[worker_nodes:vars]
ansible_ssh_private_key_file=~/.ssh/${CLUSTER_NAME}_worker-node_key
